...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(-3, -1)}')
    return f'{char_name} не нанес урон по игроку'


def defence(char_name: str, char_class: str) -> str:
    """Функция отвечает за защиту."""
    if char_class == 'warrior':
    ...
    return f'{char_name} не выбрал способность'
...
def special(char_name: str, char_class: str) -> str:
    ...
    return f'f{char_name} не применил специальное умение'


def start_training(char_name: str, char_class: str) -> str:
    """Старт игры, начинается."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    ...
    print(f'Здравствуй, {char_name}! '
          ...
          'Ты можешь выбрать один из трёх путей силы:Воитель, Маг, Лекарь')
